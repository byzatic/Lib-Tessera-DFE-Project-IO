...
/** Immutable editor-facing declaration of one routine configuration-file parameter. */
public final class RoutineConfigurationFileDescriptor {
    ...
    private RoutineConfigurationFileDescriptor(Builder builder) {
        this.key = requireText(builder.key, "key");
        this.displayName = requireText(builder.displayName, "displayName");
        this.description = Objects.requireNonNull(builder.description, "description");
        this.suggestedFileName = requireText(builder.suggestedFileName, "suggestedFileName");
        validateFileName(suggestedFileName);
        this.allowedExtensions = copyDistinctTextValues(
                builder.allowedExtensions,
                "allowedExtensions"
        );
        this.allowedScopes = List.copyOf(
        ...
        this.defaultScope = Objects.requireNonNull(builder.defaultScope, "defaultScope");
    ...
    /** Returns the ENV name under which the runtime file path is passed. */
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RoutineConfigurationFileDescriptor)) return false;
        RoutineConfigurationFileDescriptor that = (RoutineConfigurationFileDescriptor) object;
    ...
    public String toString() {
        return "RoutineConfigurationFileDescriptor{" + "key=" + key
    ...
    /** Fluent builder for immutable configuration-file declarations. */
    public static final class Builder {
        ...
        public Builder allowedExtensions(List<String> values) {
            allowedExtensions = List.copyOf(
                    Objects.requireNonNull(values, "allowedExtensions")
            );
            return this;
        }
        public Builder allowedScopes(List<ConfigurationFileScope> values) {
            allowedScopes = List.copyOf(Objects.requireNonNull(values, "allowedScopes"));
            return this;
        }
        ...
        public RoutineConfigurationFileDescriptor build() {
            return new RoutineConfigurationFileDescriptor(this);
        }
    }
}
