...
public final class ServiceParameterDescriptor {
    ...
    private ServiceParameterDescriptor(Builder builder) {
        ...
        if (selectOptions.stream().anyMatch(value -> value.isBlank())) {
    ...
    /** Returns a new builder for a service parameter descriptor. */
    public static Builder newBuilder() {
        return new Builder();
    }

    /** Returns the stable parameter identifier. */
    ...
    /** Returns the default serialized value. */
    ...
    /** Returns the semantic storage role. */
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ServiceParameterDescriptor)) {
            return false;
        }
        ServiceParameterDescriptor that = (ServiceParameterDescriptor) object;
    ...
    public String toString() {
        return "ServiceParameterDescriptor{" +
    ...
    public static final class Builder {
        ...
        public Builder selectOptions(List<String> values) {
            this.selectOptions = List.copyOf(
                    Objects.requireNonNull(values, "selectOptions")
            );
            return this;
        }
